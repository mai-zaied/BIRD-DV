...
class bird_seq_remote_seqmix extends bird_seq_base;
    function new(); super.new("remote_seqmix"); endfunction
    task body(bird_env env);
        ...
        g2=env.gen().make_remote(b,2,6,8'hB0,8'hB1,1);
        ...
        env.rcov.sample_packet(2,0,1,bird_remote_coverage::DROP_SEQ_MIX);
    endtask
endclass
