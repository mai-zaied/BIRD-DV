...
class bird_seq_remote_inorder extends bird_seq_base;
    function new(); super.new("remote_inorder"); endfunction
    task body(bird_env env);
        ...
        env.rcov.sample_packet(2,0,0,bird_remote_coverage::DROP_NONE);
    endtask
endclass
